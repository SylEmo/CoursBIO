...
public class KMPAlgorithm {
	...
	public void doYourJob(){
		System.out.println("\nLancement du pré-process...");
		computeTab();
		
		System.out.print("\nTableau après pré-process : ");
	...
	public void computeTab(){
		...
		tabComputePattern[0] = 0; // pour la premi�re lettre du pattern
		
		while (index < pattern.length() - 1) {
			System.out.print(" -- Nouvelle boucle : index = " + index);
			System.out.print(", ");
			index++;
			System.out.print("incrémente index = " + index);
			System.out.print(", ");
	...
	public void search(){
		...
		for (int indexSeq = 0; indexSeq < sequence.length() - 1; indexSeq++) {
			...
			while (indexPat < pattern.length() && indexPat + indexSeq < sequence.length() 
				...
				similarChars++;
				System.out.print("incrémente similarChars = " + similarChars);
				System.out.print(", ");
				indexPat++;
				System.out.print("incrémente indexPat = " + indexPat);
				System.out.print(", ");
